...
<div class="header">
  ...
  <li class="nav-item">
    <a class="nav-link" href="indexr.php">Register</a>
  </li>
  <li class="nav-item">
...
<div style=" justify-content: center; align-items: center; display: flex;" class="row">
    <div class="col-1 col-lg-4">
        <a style="font-size: 40px;" href="quizzeurs.php">A Quizzeur</a> <br>
        
    </div>
    <div class="col-2 col-lg-4">
    <a style="font-size: 40px;" href="users.php">A User</a> 
    </div>
    <div class="col-3 col-lg-4">
    <a style="font-size: 40px;" href="admins.php">An Admin</a> 
    </div>
</div>
</div>
