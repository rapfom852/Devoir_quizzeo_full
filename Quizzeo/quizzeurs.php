...
<html>
  ...
  <li class="nav-item">
    <a class="nav-link" href="quizzeurr.php">Register</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">About</a>
  </li>
  <li class="nav-item">
    <a style="font-size: x-large; font-weight: Bold;" class="nav-link disabled" href="indexs.php">QUIZZEO</a>
  </li>
  </ul>
